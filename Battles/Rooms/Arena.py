...
class Arena(Level):
    ...
    def __init__(self, screen, joysticks):
        ...
        with open("teams.txt", "r") as f:
            ...
            print(team_names)
            Globals.blue_team_name, Globals.red_team_name = team_names[0], team_names[1]
    ...
    def init_timer_and_score(self):
        ...
        self.counter_text = TextObject(
            self, 0, 10, "{}:{:02d}".format(text_minutes, text_seconds), 28, "moby_monospace"
        )
    ...
    def update_screen_text(self):
        ...
        self.counter_text.x = Globals.SCREEN_WIDTH / 2 - 52
